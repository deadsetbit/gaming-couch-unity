...
- Result schema: placements, ties, teams, DNF, no-contest, abandoned rounds, score snapshots, result reasons, and per-player summaries.
...
- Should result events replace the existing game-over placement payload or coexist during migration?
