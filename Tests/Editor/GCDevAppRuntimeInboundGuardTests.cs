...
// message deserializes to a non-null, zero-valued instance. The router probes the raw
// (compact) JSON for the key tokens, so a missing-key message is ignored instead of
// applying zeros. These types live behind #if UNITY_EDITOR.
